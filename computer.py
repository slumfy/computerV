...
class computer:
	...
	def solve_2_degre(self):
		...
		if self.DELTA == 0:
			...
			print ("This polynomial equation have 2 solution:\nX1 = " + str(-self.B) + " + square(" + str(self.DELTA) + ") / " + str(2 * self.A) + "\nX2= " + str(-self.B) + " - square(" + str(self.DELTA) + ") / " + str(2* self.A))
			X1 = (-self.B + utils.Sqrt(self.DELTA)) / 2 * self.A
			X2 = (-self.B - utils.Sqrt(self.DELTA)) / 2 * self.A
			print ("X1 = " + str(X1) + " X2 = " + str(X2))
		elif self.DELTA < 0:
			print ("This polynomial equation have 2 complex solution:\nX1 = " + str(-self.B) + " - i * square(" + str(-self.DELTA) + ") /" + str(2* self.A) + "\n" + "X2= " + str(-self.B) + " + i * square(" + str(-self.DELTA) + ") /" + str(2* self.A))
